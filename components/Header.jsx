...
const NAV_LINKS = [
  ...
  { href: '/nosotros', label: 'Nosotros', match: (p) => p.startsWith('/nosotros') || p.startsWith('/equipo') },
];
...
export default function Header() {
  ...
  return (
    <>
      ...
      <a className="wa-float" href={`https://wa.me/${SITE_CONTACT.phoneDigits}`} target="_blank" rel="noopener noreferrer" title="Escríbenos por WhatsApp">
