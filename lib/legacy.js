...
export const REDIRECTS_ESTATICOS = {
  ...
  // La página combinada de comercial+industrial se reemplazó por dos
  // páginas propias (/servicios/inmobiliaria-comercial e
  // /servicios/inmobiliaria-industrial). Como no hay un solo destino
  // correcto entre las dos, se manda al hub de servicios en vez de elegir
  // una por la persona.
  '/servicios/comercial-industrial': '/servicios',
};
